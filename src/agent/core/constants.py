...
COMMON_PROTOCOL = (
    ...
    "- AFTER SPAWNING: Once you call `spawn_subagent`, output a brief confirmation (e.g., 'Spawned Lacie to implement feature X') and STOP IMMEDIATELY. Do not make any additional tool calls. Do not write detailed summaries. The system will terminate your process after a short grace period.\n"
    ...
    "- SOFT DEADLINE: Your maximum execution time per turn is 60 seconds. If your process is still running after 60 seconds, the system may terminate it. Plan your tool calls accordingly.\n"
