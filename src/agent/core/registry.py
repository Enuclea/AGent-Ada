...
class ToolRegistry:
    ...
    def resolve_subagent_profile(self, agent_profile: Optional[str]) -> Optional[str]:
        ...
        builtins["lacie"] = (
            ...
            "- Note: The workspaces /home/dan/AGent and /home/dan/AGent-Ada are volume-mounted directly inside your container at their host paths. You have direct file read/write access. Use standard file tools directly on these paths rather than writing custom python files or routing filesystem requests through the host worker.\n\n"
            "TEAM MANAGEMENT:\n"
